...
@Component({
  selector: 'app-delivery-gate-pass',
  templateUrl: './delivery-gate-pass.component.html',
  styleUrls: ['./delivery-gate-pass.component.css']
})
export class DeliveryGatePassComponent implements OnInit {
