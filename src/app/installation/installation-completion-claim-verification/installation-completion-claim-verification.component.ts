...
@Component({
  selector: 'app-installation-completion-claim-verification',
  templateUrl: './installation-completion-claim-verification.component.html',
  styleUrls: ['./installation-completion-claim-verification.component.css']
})
export class InstallationCompletionClaimVerificationComponent implements OnInit {
