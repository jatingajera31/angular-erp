...
@Component({
  selector: 'app-installation-completion-claim-self-approval',
  templateUrl: './installation-completion-claim-self-approval.component.html',
  styleUrls: ['./installation-completion-claim-self-approval.component.css']
})
export class InstallationCompletionClaimSelfApprovalComponent implements OnInit {
