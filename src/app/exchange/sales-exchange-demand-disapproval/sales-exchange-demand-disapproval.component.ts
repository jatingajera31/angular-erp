...
@Component({
  selector: 'app-sales-exchange-demand-disapproval',
  templateUrl: './sales-exchange-demand-disapproval.component.html',
  styleUrls: ['./sales-exchange-demand-disapproval.component.css']
})
export class SalesExchangeDemandDisapprovalComponent implements OnInit {
